...
def generate_multi_headed_LBCS_policy(hamil: QubitOperator, n_qubit, n_head,
                                      init_params=None, batch_size=-1, max_steps=500000, seed=1234):
        ...
        for i in pbar:
            ...
            if batch_n >= n_pauliwords:
                ...
                if n_epoch % 30 == 0:
                    ...
                    pbar.set_description('Loss: {:.6f}'.format(var))
...
if __name__ == '__main__':
    ...
    init_params = {
        ...
        "heads": jnp.concatenate(
            [ogm.heads_tensor, jax.random.uniform(rng_key, (n_head - init_n_head, 12, 3), minval=5, maxval=10)]),
    }
